...
public class FacturaController {
    ...
    public String guardar(@Valid Factura factura,
        ...
        if (itemId == null || itemId.length == 0) {
            model.addAttribute("titulo", "Crear Factura");
            model.addAttribute("error", "Error: La factura debe tener al menos 1 línea de producto.");
            return "facturas/form";
        }
        ...
        flash.addFlashAttribute("success", "La factura fue agregada con éxito!");
    ...
    public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
        ...
        if (factura != null) {
            ...
            flash.addFlashAttribute("success", "La factura fue eliminada con éxito.");
            return "redirect:/ver/" + factura.getCliente().getId();
        }

        flash.addFlashAttribute("error", "La factura no existe en la DB. No se borró.");
