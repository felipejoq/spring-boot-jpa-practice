package com.uncodigo.springboot.app.view.pdf;
...
public class FacturaPdfView extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model,
        ...
        cell.setBackgroundColor(new Color(166, 237, 234));
        cell.setPadding(8f);
        ...
        cell.setBackgroundColor(new Color(180, 219, 139));
        cell.setPadding(8f);
        ...
        tabla3.setWidths(new float[] {3.5f, 1, 0.8f, 1});
